		...
		try(Scanner sc = new Scanner(System.in)){
			...
			do {
				...
				try {
					...
					case 5:
						ArrayList<Cricketer> ratingsOfPlayers = 
							new ArrayList<>(cricketerMap.values());
						Collections.sort(ratingsOfPlayers, new Comparator<Cricketer>() {
						...
						for(Cricketer cricPlayer : ratingsOfPlayers)
							System.out.println(cricPlayer);
						break;
