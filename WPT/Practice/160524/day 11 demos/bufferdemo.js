...
console.log(buf1.includes('this')); // This will print true
console.log(buf1.toJSON()); // convert data into JSON format(chars to ASCII)
var x=Buffer.from('a buffer example')
console.log(buf1.includes(x)); // This will print false
